    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ flex: 1, height: '1px', background: 'var(--border-strong)', maxWidth: '180px' }} />
          <span
            style={{
              display: 'inline-flex',
              alignItems: 'center',
        ...
        >
          ...
          <span
            style={{
              backgroundImage: 'linear-gradient(135deg, var(--cyan) 0%, var(--violet) 100%)',
        ...
        >
          ...
          실제 운영되는 서비스를 만들어 온{' '}
          <strong style={{ color: 'var(--ink)', fontWeight: 700 }}>풀스택 개발자 서인석</strong>입니다.
        </p>
